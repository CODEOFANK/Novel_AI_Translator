...
#        Trans_text = translator.translate(In_text).text
        ...
        ToEng_url = "https://clients5.google.com/translate_a/t?client=dict-chrome-ex&sl=auto&tl=en&q=" + In_text
#        print(ToEng_url)
        Trans_text = requests.get(ToEng_url, headers=headers).json()
#        print(Trans_text)

        try:
            merge_text = ''.join(Trans_text)
            print(merge_text)
        except KeyError:
            pass
